  ...
  <div class="container">
    <div class="field-container">
      ...
      <InputNumber
        ...
        @update:model-value="$emit('update:swimmingInformation' , { ...swimmingInformation, distanceInM: $event })"
      />
    </div>
    <div class="field-container">
      <label
      ...
      <Calendar
        ...
        time-only
        @update:model-value="$emit('update:swimmingInformation', { ...swimmingInformation, time: $event })"
      />
    </div>
  </div>
</template>

...
defineEmits<{
  (e: "update:runningInformation", runningInfo: RunningInformation): void;
}>();
</script>

<template>
  <Divider align="center" type="aolid">
    <b>Running</b>
  </Divider>
  <div class="container">
    <div class="field-container">
      <label for="RunningDistance" class="label">Distance in KM:</label>
      <InputNumber
        :model-value="runningInformation?.distanceInKm"
        input-id="RunningDistance"
        locale="de-DE"
        :min-fraction-digits="2"
        @update:model-value="
          $emit('update:runningInformation', {
            ...runningInformation,
            distanceInKm: $event,
          })
        "
    ...
    <div class="field-container">
      <label for="RunningTime" class="label">Time:</label>
      <Calendar
        id="RunningTime"
        :model-value="runningInformation?.time"
        time-only
        @update:model-value="
          $emit('update:runningInformation', {
            ...runningInformation,
